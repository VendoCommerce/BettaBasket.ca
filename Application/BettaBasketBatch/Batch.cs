...
namespace Com.ConversionSystems
{
    public class Batch : Com.ConversionSystems.UI.BasePage
    {
            ...
            try
            {
                ...
                foreach (Order orderItem in orders)
                {
                    try
                    {
                        ...
                        bool isCanada = true; // this batch is for Canada site (whole domain). // orderItem.VersionName.ToLower().Equals("canada")
                        ...
                        _OrderOrderHeader.UNIQUEID = "BETTACA" + _intOrderID.ToString();
        ...
        public static void sendDeclineEmail(string DeclineToEmail, string FirstName, string LastName, string version)
        {
            ...
            message.From = new MailAddress("info@bettabasket.ca");
            ...
            sb.Append("Please visit our Website (http://www.bettabasket.ca) and place an order with a new card.<br /><br />");
        ...
        public static void sendEmailToAdmin(string OMSResponse, string Orderid)
        {
            ...
            message.From = new MailAddress("info@bettabasket.ca");
                ...
                message.Subject = "Alert - BettaBasket.ca - Unable to process Orderid = "+Orderid;
