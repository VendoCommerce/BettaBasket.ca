<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MIdReport.aspx.cs" Inherits="CSWeb.Admin.MIdReport" EnableEventValidation="false"
...
<head id="Head1" runat="server">
    ...
    <title><%=siteName %> - MID Report</title>
...
<body>
    ...
    <div id="outerwrap2">
        <div id="header2">
            <div id="logo">
                <img src="//d13t42fdokvv1b.cloudfront.net/images/conversion_logo.jpg" width="238" height="62" />
            </div>
            <!-- end logo -->
            <!-- end log_link -->
            <div id="report_nav">
