            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td nowrap align="center" width="10%">
                        <asp:HyperLink ID="hlAddState" runat="Server"><img title='Add States' src='//d13t42fdokvv1b.cloudfront.net/images/admin/edit.gif' alt="Add States" border="0"></asp:HyperLink>&#160;
                    </td>
                </tr>
            </ItemTemplate>
        </asp:DataList>
